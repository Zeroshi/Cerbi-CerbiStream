...
## 2.0.6 - 2026-07-11
- Republished the package with the remediated OpenTelemetry dependency set (`OpenTelemetry` / `OpenTelemetry.Api` 1.15.3), addressing CVE-2026-40894 for downstream consumers and closing issue #31.
